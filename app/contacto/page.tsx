...
export default function ContactoPage() {
  return (
    <>
      <PageHero
        eyebrow="Contacto"
        title="Reserva un Descubrimiento Blueprint"
        description="Una conversación de 30 minutos para identificar el proceso que más tiempo le está haciendo perder a tu negocio, antes de hablar de tecnología."
